...
exports.default = function (dropdown) {
   ...
   try {
      var _loop = function _loop() {
         ...
         dropdownMenu.addEventListener('mouseover', function (ev) {
            entered = true;
         });
...
exports.default = function (hamburger) {
...
exports.default = function (smoothScroll) {
    ...
    try {
        var _loop = function _loop() {
            ...
            el.addEventListener('click', function (ev) {
                ev.preventDefault();
                var loc = document.querySelector(el.hash).offsetTop;
                scrollTo(loc);
            });
        };
    ...
    var scrollTo = function scrollTo(loc) {
        var scrollDuration = 200;
        console.log(loc / (scrollDuration / 15));

        var scrollStep = loc / (scrollDuration / 15);
...
var _factory = require('./helpers/factory');

var _factory2 = _interopRequireDefault(_factory);

var _dropdown = require('./helpers/dropdown');

var _dropdown2 = _interopRequireDefault(_dropdown);

var _background = require('./widgets/background');

var _background2 = _interopRequireDefault(_background);

var _hamburger = require('./helpers/hamburger');
...
var _game = require('./widgets/game');
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   _factory2.default.attach('.js-background-img', _background2.default);
   _factory2.default.attach('body', _game2.default);
   _factory2.default.attach('#carousel', _carousel2.default, {
      el: 'carousel',
      autoplay: false,
      interval: 1500,
      initial: 0,
...
},{"./helpers/dropdown":1,"./helpers/factory":2,"./helpers/hamburger":3,"./helpers/smooth-scroll":4,"./widgets/background":6,"./widgets/carousel":7,"./widgets/game":8,"babel-polyfill":9,"ima.js-babel6-polyfill":304,"whatwg-fetch":307}],6:[function(require,module,exports){
'use strict';
...
var Background = function () {
   function Background(elem) {
      ...
      if (this.element) {
         var imgUrl = this.element.dataset.img;
         var img = this.splitUrl(imgUrl);
   ...
   _createClass(Background, [{
      key: 'splitUrl',
      value: function splitUrl(imgUrl) {
      ...
      key: 'setBackground',
      value: function setBackground(imgUrl) {
...
function Carousel(elem, options) {
    var el = document.getElementById(options.el),
        ...
        current = 0,
        cycle = null;
    var controlContainer = elem.querySelector('.carousel-controls');
    var carouselFrame = elem.querySelector('.carousel');
...
var Game = function () {
   ...
   _createClass(Game, [{
      ...
      key: 'okIllHireYou',
      value: function okIllHireYou() {
         return yes();
      }
   }, {
      key: 'justCoz',
      value: function justCoz() {
         return 'hardly an excuse, but thats fine, thanks for your consideration';
      }
   }, {
      key: 'fuckOff',
      value: function fuckOff() {
...
},{"core-js/fn/regexp/escape":10,"core-js/shim":303,"regenerator-runtime/runtime":306}],10:[function(require,module,exports){
...
},{"_process":305}],307:[function(require,module,exports){
(function(self) {
  'use strict';
